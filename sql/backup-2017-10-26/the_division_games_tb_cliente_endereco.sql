...
CREATE TABLE `tb_cliente_endereco` (
  `id_cliente_endereco` int(4) NOT NULL AUTO_INCREMENT,
  `id_cliente` int(4) NOT NULL,
  `id_endereco` int(4) NOT NULL,
  PRIMARY KEY (`id_cliente_endereco`),
  KEY `fk_cliente_idx` (`id_cliente`),
  KEY `fk_endereco_idx` (`id_endereco`),
  CONSTRAINT `fk_cliente_tb_cliente_endereco` FOREIGN KEY (`id_cliente`) REFERENCES `tb_cliente` (`id_cli`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_endereco_tb_cliente_endereco` FOREIGN KEY (`id_endereco`) REFERENCES `tb_endereco` (`id_endereco`) ON DELETE NO ACTION ON UPDATE NO ACTION
