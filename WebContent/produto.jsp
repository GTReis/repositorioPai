			...
			<div class="site-header">
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item home"><a href="index.jsp"><i class="icon-home"></i></a></li>
								...
								<div class="col-sm-6 col-md-4">
									<div class="product-images">
										<figure class="large-image">
											<a href="BuscaImagem?id=${produto.id}.jpg"><img src="BuscaImagem?id=${produto.id}" alt=""></a>
										</figure>
	
											<c:forEach var="img" items="${imagem}">
										
												<div class="thumbnails">
													<a href="BuscaGaleria?id=${img.id}"><img src="BuscaGaleria?id=${img.id}" alt=""></a>
												</div>
						...
						<section>
							...
							<div class="product-list">
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="image/alphaprotocol.jpg" alt="Game 1" height="250" width="200">
										</div>
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="image/gta5.jpeg" alt="Game 2" height="250" width="200">
										</div>
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="image/needforspeed.jpg" alt="Game 3" height="250" width="200">
										</div>
								...
								<div class="product">
									<div class="inner-product">
										<div class="figure-image">
											<img src="image/bighunter.png" alt="Game 4" height="250" width="200">
										</div>
